...
def render_system_message() -> str:
    ...
    system_template = load_prompt('/home/txx/projects_new/CCrafter/baselines/ReAct_cor/system_prompt.txt')
    
    programs = load_text('/home/txx/projects_new/CCrafter/baselines/ReAct_cor/programs.txt')
...
def main():
    ...
    parser.add_argument('--load_world', type=pathlib.Path, default="/home/txx/projects_new/CCrafter/create_world/default")
